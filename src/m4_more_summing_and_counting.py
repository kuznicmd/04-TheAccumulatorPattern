...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 1
    answer = count_cosines_from(1, 4, 0.15)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 2
    answer = count_cosines_from(3, 10, 0.32)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 0
    answer = count_cosines_from(2, 4, 0.05)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 3
    answer = count_cosines_from(5, 7, 0.27)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 2
    answer = count_cosines_from(2, 9, 0.37)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 1.928968  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(2, 10)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = 1.092857  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(3, 7)
